...
For weight **above 7000**, the output is **"OVERLOADED"**, and for all other inputs, the output statement is **"INVALID INPUT"**.
...
w=int(input())
if w==0:
  print("Time Estimated: 0 Miniutes")
elif w in range(1,2001):
  print("Time Estimated: 25 Miniutes")
elif w in range(2001,4001):
  print("Time Estimated: 35 Miniutes")
elif w in range(4001,7001):
  print("Time Estimated:45 Miniutes")
else:
  print("INVALID INPUT")
